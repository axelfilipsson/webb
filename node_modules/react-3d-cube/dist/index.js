...
var emptyFace = React.createElement("div", { className: styles.empty }, "empty");
var Cube = /** @class */ (function (_super) {
    __extends(Cube, _super);
    function Cube(props) {
        var _this = _super.call(this, props) || this;
        _this.dragCube = function () {
            var _a = _this.state, cube = _a.cube, mouseDelta = _a.mouseDelta;
            ...
            _this.setState({
                cube: __assign({}, cube, { rotateX: rotateX,
                    rotateY: rotateY })
            });
        };
        ...
        _this.handleMouseMove = function (e) {
            var pageX = e.pageX, pageY = e.pageY;
            var _a = _this.state, isPressed = _a.isPressed, _b = _a.mouseXY, mx = _b[0], my = _b[1];
            if (isPressed) {
                _this.setState({
                    mouseXY: [pageX, pageY],
    ...
    Cube.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.cubeWrapper },
            React.createElement(reactMotion_1, { style: {
                ...
                var rotateX = _a.rotateX, rotateY = _a.rotateY, rotateZ = _a.rotateZ;
                return (React.createElement("div", { className: styles.cube, style: {
                    ...
                    var _a = faces[face], translate = _a.translate, rotate = _a.rotate;
                    return (React.createElement("div", { className: styles.cubeFace + " " + styles[face], key: key, style: {
